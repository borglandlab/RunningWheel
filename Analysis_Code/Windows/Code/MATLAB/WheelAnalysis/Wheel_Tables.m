...
%% 4. Presenting data as activity during the 3 hours of feeding
...
%% 5. Presenting data as activity from 3:30 PM to 6:30PM

x_date = [Acclimation_day1 : Restriction_final]';
[year_index,month_index,day_index] = ymd(x_date);
for n = 1:length(x_date)
    x_date_feedtime1(n) = datetime(year_index(n), month_index(n), day_index(n), 14, 30, 0);
end
x_date_feedtime1.TimeZone = timezone;
