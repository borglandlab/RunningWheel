...
2. Create the executable setup file.
    ...
    3. Enter the following into the terminal window and press "return" (This will take a bit of time to create your executable file):
	```{console}
...
* pyinstaller can't recognize matlabengine, so you need to manually add it. For this reason there are a few extra steps.
    ...
    7. Right click on the folder called "Python" and select "New Terminal at Folder". Then enter the following code into the terminal window:
	```{console}
